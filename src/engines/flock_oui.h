...
static const uint8_t FLOCK_OUI_TABLE[][3] = {
    {0x00,0x18,0x0a}, // Murata
    {0x00,0x23,0x6c}, // Sierra Wireless
    {0x00,0xf4,0x8d}, // Cradlepoint
    {0x04,0x0d,0x84}, // Cradlepoint
    {0x08,0x3a,0x88},
    {0x14,0x5a,0xfc},
    {0x14,0xb5,0xcd},
    {0x1c,0x34,0xf1},
    {0x1c,0xb7,0x2c}, // Murata
    ...
    {0x58,0x8e,0x81},
    {0x5c,0x93,0xa2},
    {0x60,0x62,0x01}, // Sierra Wireless
    {0x64,0x6e,0x69},
    {0x70,0x08,0x94}, // Espressif
    {0x70,0xc9,0x4e},
    {0x74,0x4c,0xa1},
    {0x80,0x30,0x49},
    {0x82,0x6b,0xf2},
    ...
    {0x90,0x35,0xea},
    {0x94,0x08,0x53},
    {0x94,0x2a,0x6f}, // Espressif
    {0x94,0x34,0x69}, // Espressif
    ...
    {0xb4,0x1e,0x52}, // Flock Group Inc. (direct)
    {0xb4,0xe3,0xf9},
    {0xb8,0x1e,0xa4},
    {0xb8,0x35,0x32},
